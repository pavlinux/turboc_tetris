...
#define kbLeft    KEY_LEFT	/* Fl�che de gauche (Left) */
#define kbKeypad5 KEY_B2	/* 5 du bloc num�rique */
#define kbRight   KEY_RIGHT	/* Fl�che de droite (Right) */
#define kbDn      KEY_DOWN	/* Fl�che du bas (Down) */
